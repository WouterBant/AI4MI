...
class SAM2UNet(nn.Module):
    def __init__(self, checkpoint_path=None) -> None:
        ...
        self.up3 = Up(128, 64)
        self.up4 = Up(128, 64)
        self.side1 = nn.Conv2d(64, 5, kernel_size=1)
        self.side2 = nn.Conv2d(64, 5, kernel_size=1)
        self.head = nn.Conv2d(64, 5, kernel_size=1)

    def forward(self, x):
        if x.shape[1] == 1:
            # If input is grayscale, replicate the channel to create a 3-channel tensor
            x = x.repeat(1, 3, 1, 1)
