...
# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/mainbestweights//bestweights_samed_512_r6_augment_no_normalize_no.pt
