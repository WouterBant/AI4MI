...
# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/main/bestweights_samed_1024_r4_augment_yes_normalize_yes.pt

# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/main/bestweights_samed_1024_r6_augment_no_normalize_no.pt
# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/main/bestweights_samed_1024_r6_augment_yes_normalize_no.pt
# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/main/bestweights_samed_1024_r6_augment_no_normalize_yes.pt
# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/main/bestweights_samed_1024_r6_augment_yes_normalize_yes.pt

# wget --header="Referer: https://huggingface.co/" -P . https://huggingface.co/Wouter01/AI4MI/resolve/main/bestweights_crf_samed_512_r6_augment_yes_normalize_no.pt
